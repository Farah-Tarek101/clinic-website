...
const Settings = () => {
  ...
  const fetchNotificationSettings = async () => {
    try {
      const response = await axios.get(`${import.meta.env.VITE_API_BASE_URL}/api/v1/user/notification-settings`, {
  ...
  const handleSaveNotificationSettings = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/api/v1/user/notification-settings/update`,
        {
          emailNotificationsEnabled,
          notificationDays,
          notificationHours,
  ...
  const handleUpdateProfile = async () => {
    ...
    try {
      ...
      const response = await axios.put(
        `${import.meta.env.VITE_API_BASE_URL}/api/v1/user/update-profile`, // Adjust this endpoint as needed
        profileData,
        { withCredentials: true }
      );
