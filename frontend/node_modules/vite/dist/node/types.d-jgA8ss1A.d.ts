...
import { HMRPayload, Update } from 'vite/types/hmrPayload.js';
...
export { ViteRuntime as b, ssrExportAllKey as i, ssrImportKey as j, ssrImportMetaKey as k, ssrModuleExportsKey as l, ModuleCacheMap as M, ssrDynamicImportKey as s, type ViteModuleRunner as a, type HMRRuntimeConnection as c, type FetchFunction as d, type ViteRuntimeModuleContext as e, type FetchResult as F, type HMRConnection as f, type ModuleCache as g, type HMRLogger as H, type ViteRuntimeImportMeta as h, type ResolvedResult as R, type SSRImportMetadata as S, type ViteRuntimeOptions as V };
