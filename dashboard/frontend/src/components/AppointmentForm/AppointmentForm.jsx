  ...
  return (
    <div className="container form-component appointment-form">
      ...
      <form onSubmit={handleSubmit} noValidate>
        ...
        <div className="form-group">
          <label htmlFor="doctorFullName">{t("doctorName")}</label>
          <select
            id="doctorFullName"
            name="doctorFullName"
        ...
        <div className="confirmation-modal">
          <div className="confirmation-content">
            ...
            <ul>
              ...
              <li><strong>{t("mobileNumber")}:</strong> {formData.phone}</li>
              <li><strong>{t("gender")}:</strong> {t(formData.gender.toLowerCase())}</li>
              <li><strong>{t("dateOfBirth")}:</strong> {formData.dob}</li>
              <li><strong>{t("appointmentDate")}:</strong> {formData.appointmentDate}</li>
              <li><strong>{t("appointmentTime")}:</strong> {formData.appointmentTime}</li>
              <li><strong>{t("department")}:</strong> {t(formData.department.toLowerCase())}</li>
              <li><strong>{t("doctorName")}:</strong> {formData.doctorFullName}</li>
