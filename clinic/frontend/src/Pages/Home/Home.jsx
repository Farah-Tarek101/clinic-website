    ...
    <>
      ...
      <div className="home-cards-container">
        <div className="home-card">
          <i className="fas fa-clinic-medical card-logo"></i>
        ...
        <div className="home-card">
          <i className="fas fa-stethoscope card-logo"></i>
        ...
        <div className="home-card">
          <i className="fas fa-comments-medical card-logo"></i>
        ...
        <div className="home-card">
          <i className="fas fa-plus-circle card-logo"></i>
          <h3>{t("new")} {t("services")}</h3>
          <p>
            {t("oasis")} {t("clinics")} {t("is")} {t("more")} {t("than")} {t("just")} {t("a")} {t("medical")} {t("care")} {t("center")}. 
